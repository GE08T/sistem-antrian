...
<div class="user-page-index">
    ...
    <div class="card-body">
        <p class="card-text">Disini adalah tempat user untuk mengambil nomor antrian, <br> Klik <?= Html::a('klik disini', [''], ['class' => 'link']) ?> atau klik menu ambil antrian di samping kemudian pilih loket dan klik tombol ambil antrian.</p>
    </div>
    </div>
